...
import { SaveUserPicture, LoadUserProfile } from '@/domain/contracts/repository'
...
describe('ChangeProfilePicture', () => {
  ...
  beforeEach(() => {
    ...
    userProfileRepo.load.mockResolvedValue({ name: 'Rodrigo Abreu de Oliveira' })
  ...
  it('should call SaveUserPicture with correct input when file is undefined', async () => {
    userProfileRepo.load.mockResolvedValueOnce({ name: 'rodrigo abreu de oliveira' })
